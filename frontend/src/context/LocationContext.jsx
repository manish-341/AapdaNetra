...
export const INDIAN_DISTRICT_GAZETTEER = {
  ...
  'sagar': { lat: 23.8388, lng: 78.7378, state: 'Madhya Pradesh', name: 'Sagar' },
  'dewas': { lat: 22.9676, lng: 76.0534, state: 'Madhya Pradesh', name: 'Dewas' },
  'ratlam': { lat: 23.3315, lng: 75.0367, state: 'Madhya Pradesh', name: 'Ratlam' },
